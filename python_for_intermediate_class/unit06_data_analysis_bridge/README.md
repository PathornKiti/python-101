...
Unit 06 helps students turn "my app saves data" into "my app produces data I can trust, analyze, present, and reuse."

## Why This Unit Belongs Here

| Course Position | What Students Already Have | What Unit 06 Adds | What It Prepares Students For |
|---|---|---|---|
| After Units 01-05 and Project 1 | Scripts, modules, imports, command-line workflows, Git, `venv`, tests, logging, JSON or CSV storage, and a structured CLI project | Clean data files, reusable analysis functions, summary tables, and short written findings | Visualization, reports, Streamlit dashboards, API data processing, and capstone project planning |
...
This folder currently contains the Markdown teaching plan for Unit 06. Suggested lesson files can be added as the unit is developed.
...
| Earlier Unit | Skill Students Bring Into Unit 06 | How Unit 06 Reuses It |
|---|---|---|
...
| Unit 03: command line | Terminal commands and project folder navigation | Run analysis scripts from the terminal. |
| Unit 04: Git and `venv` | Virtual environments, dependency files, Git history, and commits | Use a project environment, track data-processing changes with Git, and save any analysis dependencies. |
| Unit 05: testing, debugging, logging, JSON, and CSV | Safer code, tests, logs, and saved data | Validate data, test summary functions, and load the JSON or CSV files from Project 1. |
...
| Later Unit | What Unit 06 Provides | Why It Helps |
|---|---|---|
| Unit 07 Part 1: Visualization and Reports | Cleaned data and summary tables | Charts become easier because data is already organized and meaningful. |
| Unit 07 Part 2: Streamlit Basics | Reusable summary functions and clean display data | The dashboard can focus on interaction and presentation instead of messy data handling. |
| Unit 08 Part 1: API Basics | A pattern for reading, validating, and summarizing structured data | Students can apply the same pattern to JSON returned by APIs. |
| Unit 08 Part 2: API App with Error Handling | Data quality habits and fallback thinking | Students are better prepared for missing fields, failed requests, and inconsistent external data. |
...
| 1:50-2:00 | Preview next unit | Connect summaries to charts, reports, Streamlit, APIs, and capstone metrics | Clear bridge to Unit 07 |
...
7. Create a short `analysis_notes.md` file with:
   ...
   - one chart or dashboard idea for Unit 07.

## Best Practice Checklist

Before moving to Unit 07, check that:
